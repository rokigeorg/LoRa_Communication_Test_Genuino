...
//======================setup HopeRF 95M======================================
    ...
    rf95.setSpreadingFactor(SF12);

    // adjust the BW and the Code Rate
    rf95.setBandwidthAndCodingRate(rf95.Bw500Cr45);


    Serial.write(rf95.printRegisters());
}
